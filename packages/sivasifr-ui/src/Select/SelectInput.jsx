...
const SelectInput = React.forwardRef((props, ref) => {
  ...
  return (
    <>
      <div
        className={clsx(
          'select-wrap', // TODO v5: merge root and select
          'select',
          'select-selectMenu',
          {
            'select-disabled': disabled,
            'select-filled': variant === 'filled',
      ...
      <input
        ...
        {...other}
      />
      <SvgUse name={IconComponent} className="text-muted" />
      <Menu
        id={`menu-${name || ''}`}
...
SelectInput.propTypes = {
   ...
   */
  inputRef: PropTypes.oneOfType([PropTypes.func, PropTypes.PropTypes.object]),
  /**
