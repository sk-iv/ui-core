...
<Story name="variants">
  <div style={{display: "flex", height: "50px"}}>
    <div style={{background:`linear-gradient(to right, hsl(var(--color-primary-start)), hsl(var(--color-primary-end)))`, width:"60%", float:"left"}}>60%</div>
    <div style={{background:'#000', width:"30%", float:"left"}}>30%</div>
    <div style={{background:'#000', width:"10%", float:"left"}}>10%</div>
  </div>
</Story>
