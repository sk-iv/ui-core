...
const Slide = React.forwardRef((props, ref) => {
  ...
  const handleEntering = (_, isAppearing) => {
    ...
    node.style.webkitTransition = `-webkit-transform ${transitionProps.duration} ease-out ${transitionProps.delay}`
    node.style.transition = `transform ${transitionProps.duration} ease-out ${transitionProps.delay}`
  ...
  const handleExit = () => {
    ...
    node.style.webkitTransition = `-webkit-transform ${transitionProps.duration} sharp ${transitionProps.delay}`
    node.style.transition = `transform ${transitionProps.duration} sharp ${transitionProps.delay}`
    setTranslateValue(direction, node)
